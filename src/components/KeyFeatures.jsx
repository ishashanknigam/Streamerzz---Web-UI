  ...
  return (
    <section>
      <div className="max-w-7xl mx-auto px-4 mt-20">
        ...
        <div className="text-center mt-12 border-t border-neutral-800">
        ...
        className="flex flex-wrap justify-between">
          {KEY_FEATURES_CONTENT.features.map((feature)=>(
            ...
            <motion.div key={feature.id} className="flex flex-col items-center text-center w-full md:w-1/2 
            lg:w-1/3 p-6"
            ...
            >
              ...
              <p className="mt-2 text-neutral-200">{feature.description}</p>
            </motion.div>
